...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="container">
    ...
    <div class="dropdown">
  <div class="btn btn-dark dropdown-toggle"  id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <ul class="navbar-nav ms-3">
        <li class="nav-item me-3">
          <a class="nav-link d-flex align-items-center" href="#!"> <i class="fa-solid fa-heart"></i>Like</a>
        </li>
        <li class="nav-item">
        ...
        <Link to='/Admin'>
          <a class="nav-link d-flex align-items-center" href="#!"> Sign</a>
          </Link>
        </li>
      </ul>
    </div>
